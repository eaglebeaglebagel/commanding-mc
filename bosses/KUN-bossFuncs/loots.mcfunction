# HES Boss loot success function
# Created by iTyro
# August 7, 2019
...
#
#
scoreboard players add HESLootTimer HESLootTimer 1
#
execute if score HESLootTimer HESLootTimer matches 5 run tellraw @a[team=HESfight] {"text":"You have recieved the loot from Hitler's Son!"}
#
execute if score HESLootTimer HESLootTimer matches 5 run execute at @a[team=HESfight] run playsound minecraft:ui.toast.challenge_complete master @p ~ ~ ~ 100
#
execute if score HESLootTimer HESLootTimer matches 5 if entity @a[team=HESfight,distance=..200] run tellraw @a {"text":"[ ","color":"white","bold":true,"extra":[{"text":"B0ss Battles ","color":"dark_purple","bold":true},{"text":"] ","color":"white","bold":true},{"selector":"@a[team=HESfight,distance=..200]","color":"white","bold":false},{"text":" just defeated Hitler's evil son!","color":"light_purple","bold":false}]}
#
#
######################################
#
...
#
#
scoreboard objectives remove minion2Timer dummy
#
scoreboard objectives remove minion1Timer dummy
#
scoreboard objectives remove HESTpTimer dummy
#
scoreboard objectives remove HESSlowness dummy
#
scoreboard objectives remove HESboombats dummy
#
scoreboard objectives remove minion1DeathTimer dummy
#
scoreboard objectives remove minion2DeathTimer dummy
#
#
###########################################
#
