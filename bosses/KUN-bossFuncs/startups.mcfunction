# HES Boss start up success function
# Created by iTyro
# August 7, 2019
# Reviewed August 7, 2019
#
#
# Tellraw announces to all players that boss has been summoned by corresponding player.
#
tellraw @a {"text":"[ ","color":"white","bold":true,"extra":[{"text":"B0ss Battles ","color":"dark_purple","bold":true},{"text":"] ","color":"white","bold":true},{"selector":"@p","color":"light_purple","bold":false},{"text":" has summoned Hitler's son, wish them luck!","color":"light_purple","bold":false}]}
#
#
# Summon cmd for HES
#
